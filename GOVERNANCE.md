...
`cloud-itonami-isco-7234` is an OSS open-occupation blueprint. Governance covers
...
- BikeCoordGovernor remains independent of the advisor.
- hard policy violations cannot be overridden by human approval.
- a repair-execution decision, a roadworthiness-clearance decision,
  and any override of a shop safety officer's judgment, stay
  permanently outside this actor's op-allowlist.
- every commit, hold and approval path is auditable.
- real repairer/shop/operator data stays outside Git.
...
- mishandling repairer/shop/operator data
- misrepresenting certification status
- failing to respond to security incidents
- hiding material changes to customer-facing operation
- attempting to route a repair-execution decision, a
