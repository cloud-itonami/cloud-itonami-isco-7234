...
2. Define consent and purpose categories for repairer/shop records.
...
- safety-critical escalation path (mechanical hazard, equipment
  condition)
- provenance for all operating records (repairer and shop both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a
  repair-execution decision, a roadworthiness-clearance decision, or
  a shop-safety-officer override decision, through this actor —
  those decisions stay the shop safety officer's exclusive authority
  end to end
...
repair-execution decision, a roadworthiness-clearance decision, or a
